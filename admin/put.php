...
if (!empty($_POST)) {
	...
	if ($s_ID != '') {
		//update
		$sql = "update student set EmployeeName = '$s_EmployeeName', Email = '$s_Email', Address = '$s_Address', PhoneNumber = '$s_PhoneNumber', Username = '$s_Username'  where ID = " .$s_ID;
	} else {
		//insert
...
if (isset($_GET['ID'])) {
	...
	if ($employeeList != null && count($em<?php
	require_once ('dbhelp.php');
