  ...
  <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
    <div class="mdk-drawer-layout__content page-content">
      ...
      <div class="navbar navbar-expand navbar-light border-bottom-2" id="default-navbar" data-primary>
        ...
        <a href="index.html" class="navbar-brand mr-16pt d-lg-none">
          <span class="avatar avatar-sm navbar-brand-icon mr-0 mr-lg-8pt">
            ...
            <span class="avatar-title rounded bg-primary"><img src="https://luma.humatheme.com/public/images/illustration/student/128/white.svg" alt="logo" class="img-fluid" /></span>

          </span>

          <span class="d-none d-lg-block">Nguyễn Thị Loan</span>
        </a>

        <ul class="nav navbar-nav ml-auto mr-0">
          <li class="nav-item">
            <a href="login.html" class="nav-link" data-toggle="tooltip" data-title="Login" data-placement="bottom"></a>
          </li>
          <li class="nav-item">
      ...
      <div class="mdk-box mdk-box--bg-primary bg-dark js-mdk-box mb-0" data-effects="parallax-background blend-background">
        ...
        <div class="mdk-box__content justify-content-center">
          <div class="hero container page__container text-center py-112pt">
            <h1 class="text-white text-shadow">Learn the word</h1>
            <p class="lead measure-hero-lead mx-auto text-white text-shadow mb-48pt">Hành trình vươn tới tương lai.</p>

            <a href="courses.html" class="btn btn-lg btn-white btn--raised mb-16pt">Browse Courses</a>

            <p class="mb-0"><a href="#" class="text-white text-shadow"><strong>Bạn muốn giáo viên nào?</strong></a></p>
      ...
      <div class="page-section border-bottom-2">
        <div class="container page__container">
          ...
          <div class="page-separator">
            <div class="page-separator__text">Các khóa học</div>
          </div>
          ...
          <div class="row card-group-row">
            ...
            <div class="col-md-6 col-lg-4 card-group-row__col">
              ...
              <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                <img src="../student1/public/images/marker/khoahoc1.jpg" alt="" class="card-img">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="avatar-group flex">
                      <div class="avatar avatar-xs" data-toggle="tooltip" data-placement="top" title="">
                        <a href="#"><img src="../student1/public/images/256_luke-porter-261779-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle"></a>
                      </div>
                    </div>
                    <a style="text-decoration: none;" class="d-flex align-items-center" href="#"><i class="material-icons mr-1" style="font-size: inherit;"></i> <small>327+</small></a>
                  </div>
                  <div class="posts-card-popular__title card-body">
                    <small class="text-muted text-uppercase">Staters</small>
                    <a class="card-title" href="blog-post.html">Chứng chỉ tiếng Anh quốc tế Starters</a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-lg-4 card-group-row__col">
              ...
              <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                <img src="../student1/public/images/marker/khoahoc2.jpg" alt="" class="card-img">
                <div class="fullbleed bg-primary" style="opacity: .5"></div>
                <div class="posts-card-popular__content">
                  <div class="card-body d-flex align-items-center">
                    <div class="avatar-group flex">
                    ...
                    <a style="text-decoration: none;" class="d-flex align-items-center" href="#"><i class="material-icons mr-1" style="font-size: inherit;"></i> <small>400+</small></a>
                  </div>
                  <div class="posts-card-popular__title card-body">
                    <small class="text-muted text-uppercase">Movers</small>
                    <a class="card-title" href="blog-post.html">Young Learners English</a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-lg-4 card-group-row__col">
              ...
              <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                <img src="../student1/public/images/marker/khoahoc3.jpg" alt="" class="card-img">
                <div class="fullbleed bg-primary" style="opacity: .5"></div>
                <div class="posts-card-popular__content">
                  <div class="card-body d-flex align-items-center">
                    <div class="avatar-group flex">
                    ...
                    <a style="text-decoration: none;" class="d-flex align-items-center" href="#"><i class="material-icons mr-1" style="font-size: inherit;"></i> <small>560+</small></a>
                  </div>
                  <div class="posts-card-popular__title card-body">
                    <small class="text-muted text-uppercase">Flyers</small>
                    <a class="card-title" href="blog-post.html">Khung trình độ chung Châu Âu (CEFR).</a>
                  </div>
                </div>
              </div>
      ...
      <div class="page-section border-bottom-2">
        <div class="container page__container">
          <div class="page-separator">
            <div class="page-separator__text">BÀI HỌC</div>
          </div>
                  ...
                  <div class="d-flex align-items-center">
                    <div class="flex">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex">
                          <div class="card-title">Gặp người mới</div>
                          <p class="flex text-50 lh-1 mb-0"><small>18 bài</small></p>
                        </div>
                      </div>
                    </div>

                    <a href="student-path.html" data-toggle="tooltip" data-title="Add Favorite" data-placement="top" data-boundary="window" class="ml-4pt material-icons text-20 card-course__icon-favorite"></a>
              ...
              <div class="popoverContainer d-none">
                <div class="media">
                  ...
                  <div class="media-body">
                    <div class="card-title">Vui lòng và cảm ơn</div>
                  ...
                  <div class="d-flex align-items-center">
                    <div class="flex">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex">
                          <div class="card-title">Vui lòng và cảm ơn </div>
                          <p class="flex text-50 lh-1 mb-0"><small>18 bài học</small></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="d-flex align-items-center">
                    <div class="flex">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex">
                          <div class="card-title">Ăn mừng và tiệc tùng</div>
                          <p class="flex text-50 lh-1 mb-0"><small>16 bài học</small></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="d-flex align-items-center">
                    <div class="flex">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex">
                          <div class="card-title">Thiên nhiên và động vật</div>
                          <p class="flex text-50 lh-1 mb-0"><small>18 bài học</small></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="d-flex align-items-center">
                    <div class="flex">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex">
                          <div class="card-title">Thế giới hoang dã</div>
                          <p class="flex text-50 lh-1 mb-0"><small>20 bài học</small></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="d-flex align-items-center">
                    <div class="flex">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex">
                          <div class="card-title">Gia đình và sức khỏe</div>
                          <p class="flex text-50 lh-1 mb-0"><small>15 bài học</small></p>
                        </div>
                      </div>
                    </div>
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <ul>
                ...
                <li><a href="mailto:sachit@gmail.com"> sunshineenglish@gmail.com</a></li>
                <li><a href="#"> 0989199399</a></li>
              </ul>
            </div>
            <div class="col-md-3">
              <h3>GIỚI THIỆU</h3>
            ...
            <div class="col-md-3">
              ...
              <div class="mangXaHoi">
                <a href="https://www.facebook.com/meowmeow.Daomeo/"></a>
                <a href="https://www.facebook.com/meowmeow.Daomeo/"></a>
                <a href="https://www.facebook.com/meowmeow.Daomeo/"></a>
              </div>
            </div>
            <div class="col-md-3">
              ...
              <div class="fanpage">
                <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v10.0&appId=2242372112682519&autoLogAppEvents=1" nonce="7nroEQad"></script>
                <div class="fb-page" data-href="https://www.facebook.com/meowmeow.Daomeo/" data-tabs="" data-width="" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                  <blockquote cite="https://www.facebook.com/meowmeow.Daomeo/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/meowmeow.Daomeo/">Đảo mèo</a></blockquote>
                </div>
              </div>
            </div>
          </div>
...
<!-- Mirrored from luma.humatheme.com/Demos/App_Layout/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 May 2021 09:34:59 GMT -->
