                        ...
                        <div class="row card-group-row">
                            ...
                            <div class="col-md-6 col-lg-4 card-group-row__col">
                                ...
                                <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                                    <img src="../student1/public/images/marker/khoahoc1.jpg"
                                         alt=""
                                         class="card-img">
                                        ...
                                        <div class="card-body d-flex align-items-center">
                                            ...
                                            <a style="text-decoration: none;"
                                               ...
                                               href="#"><i class="material-icons mr-1"
                                                   style="font-size: inherit;"></i> <small>327+</small></a>
                                        </div>
                                        <div class="posts-card-popular__title card-body">
                                            <small class="text-muted text-uppercase">Staters</small>
                                            <a class="card-title"
                                               href="blog-post.html">Chứng chỉ tiếng Anh quốc tế Starters</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4 card-group-row__col">
                                ...
                                <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                                    <img src="../student1/public/images/marker/khoahoc2.jpg"
                                         alt=""
                                         class="card-img">
                                    <div class="fullbleed bg-primary"
                                         style="opacity: .5"></div>
                                    <div class="posts-card-popular__content">
                                        <div class="card-body d-flex align-items-center">
                                            ...
                                            <a style="text-decoration: none;"
                                               class="d-flex align-items-center"
                                               href="#"><i class="material-icons mr-1"
                                                   style="font-size: inherit;"></i> <small>400+</small></a>
                                        </div>
                                        <div class="posts-card-popular__title card-body">
                                            <small class="text-muted text-uppercase">Movers</small>
                                            <a class="card-title"
                                               href="blog-post.html">Young Learners English</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4 card-group-row__col">
                                ...
                                <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                                    <img src="../student1/public/images/marker/khoahoc3.jpg"
                                         alt=""
                                         class="card-img">
                                    <div class="fullbleed bg-primary"
                                         style="opacity: .5"></div>
                                    <div class="posts-card-popular__content">
                                        <div class="card-body d-flex align-items-center">
                                            ...
                                            <a style="text-decoration: none;"
                                               class="d-flex align-items-center"
                                               href="#"><i class="material-icons mr-1"
                                                   style="font-size: inherit;"></i> <small>560+</small></a>
                                        </div>
                                        <div class="posts-card-popular__title card-body">
                                            <small class="text-muted text-uppercase">Flyers</small>
                                            <a class="card-title"
                                               href="blog-post.html">Khung trình độ chung Châu Âu (CEFR).</a>
                                        </div>
                                    </div>
                                </div>
