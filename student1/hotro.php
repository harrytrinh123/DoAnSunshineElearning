                        ...
                        <nav class="nav navbar-nav">
                            <div class="nav-item navbar-list__item">
                                <a href="student-take-course.html"
                                   class="nav-link h-auto"><i class="material-icons icon--left"></i>Quay lại khóa học</a>
                            </div>
                            <div class="nav-item navbar-list__item">
                                <div class="d-flex align-items-center flex-nowrap">
                                    <div class="flex">
                                        <a href="student-take-course.html"
                                           class="card-title text-body mb-0">Movers</a>
                                            ...
                                            <div class="list-group list-group-flush">
                                                    ...
                                                    <div class="row align-items-start">
                                                        ...
                                                        <div class="col mb-8pt mb-md-0">
                                                            <p class="mb-8pt"><a href="#"
                                                                   class="text-body"><strong>Các cấu trúc thường gặp trong Tiếng Anh?</strong></a></p>

                                                            <a href="#"
                                                               class="chip chip-outline-secondary"> Cấu trúc thường gặp</a>
                                                ...
                                                <div class="list-group-item p-3">
                                                    <div class="row align-items-start">
                                                        ...
                                                        <div class="col mb-8pt mb-md-0">
                                                            <p class="mb-0"><a href="#"
                                                                   class="text-body"><strong>Tại sao mình không thể đăng ký khóa học Movers, cần có điều kiện gì ạ?</strong></a></p>
                                            ...
                                            <div role="group"
                                                ...
                                                <div class="form-row">
                                                    <label id="label-question"
                                                           for="question"
                                                           class="col-md-3 col-form-label form-label">Chi tiết câu hỏi</label>
                                                    <div class="col-md-9">
                                            ...
                                            <div class="form-group m-0"
                                                ...
                                                <div class="form-row align-items-center">
                                                    <label id="label-topic"
                                                           for="topic"
                                                           class="col-md-3 col-form-label form-label">Chọn tệp</label>
                                                    <div class="col-md-9">
                                                            <form>
                                        ...
                                        <div class="list-group-item">
                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                <input id="notify"
                                                       ...
                                                       checked="">
                                                <label for="notify"
                                                       class="custom-control-label">Thông báo cho qua email nếu có ai trả lời câu hỏi</label>
                                            </div>
                                            <small id="description-notify"
                                                   class="form-text text-muted">Bạn vẫn sẽ nhận được thông báo của chúng tôi qua website</small>
                                        </div>
                                        <div class="list-group-item">
                                            <button type="button"
                                                    class="btn btn-accent">Đăng câu hỏi</button>
                                        </div>
                                    </div>
