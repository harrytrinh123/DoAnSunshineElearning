                        ...
                        <div class="col-lg-9">
                            <div class="page-section">
                                        ...
                                        <div class="card-body table--elevated">
                                            <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input id="title" type="text" placeholder="Your question ..." value="..." class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <div role="group" aria-labelledby="label-question" class="m-0 form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea id="question" placeholder="Mô tả chi tiết câu hỏi của bạn ..." rows="4" class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="list-group-item">
                                        <button type="button" class="btn btn-accent">Đăng câu hỏi</button>
                                    </div>
                                </div>
