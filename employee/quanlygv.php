                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">QUẢN LÝ GIÁO VIÊN</h4>
...
if (isset($_GET['s']) && $_GET['s'] != '') {
	$sql = 'select * from teacher where fullname like "%'.$_GET['s'].'%"';
} else {
...
?>
				...
				<button class="btn btn-success" onclick="window.open('gv.php', '_self')">Add Teacher</button>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		function deleteTeacher(ID) {
			option = confirm('Bạn có muốn xóa giáo viên này không')
			if(!option) {
				return;
			}
